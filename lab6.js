function setRussian() {
    ...
    document.getElementById('input-age').placeholder = 'Введите вашв возраст';
...
function showAlert2(){
let student = document.getElementById('header').value
    alert('Барабара беребере')
    let r = Math.round(Math.random()*255);
    let g = Math.round(Math.random()*255);
    let b = Math.round(Math.random()*255);
    let color = 'rgb(' + r + ',' + g + ',' + b + ')';
